  ...
  return (
    <BaseLayout>
      ...
      <div className="lg:px-[38px] mt-5 lg:-mt-[22px] flex flex-col-reverse lg:flex-row justify-center gap-5 lg:gap-[38px] relative">
        {!isConnected && (
          <div className={clsx(styles.exchangeBg, 'lg:w-[753px] lg:h-[533px] w-full h-[455px]')}>
            <div
              className={clsx(
            ...
            >
              <Text textView={TextView.H4}>
                Complete your first Swap or Exchange to view your transaction history here
              </Text>
              <Text textView={TextView.P2} className="opacity-60">
                This screen will display a record of all your Swap and Exchange operations
              </Text>
            </div>
          </div>
        )}
