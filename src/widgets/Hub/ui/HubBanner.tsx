    ...
    return (
      <div
        className={clsx(
          ...
          "before:pointer-events-none before:top-0 before:right-0 before:absolute before:w-full before:h-full before:bg-[url('/images/HubBanner.png')] before:z-50 before:bg-[length:100%_100%] before:bg-no-repeat",
        )}
      >
        <div
