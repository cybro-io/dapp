...
export const HubInvestmentAcademy = () => {
  ...
  return (
    <section id="investment-academy" className="flex flex-col gap-9 items-center">
      <div className="flex flex-col gap-4 items-center text-center">
        <Text textView={isMedium ? TextView.H3 : TextView.H2}>Cybro Investment Academy</Text>
        <Text textView={TextView.BP2} className="!text-white/80 text-center max-w-[687px]">
