    ...
    <div className={clsx(styles.root, className)}>
      <Tabs className={styles.tabs} onSelectionChange={setActive} fullWidth size="lg">
        {tabs.map(({ title, key }) => (
          <Tab
            key={key}
            title={title}
            className={clsx(styles.tab, key === active && styles.activeTab)}
          />
        ))}
      </Tabs>
      ...
      <div className={styles.projectedYield}>
        ...
        <div className={styles.yieldContainer}>
          <Text className={styles.yieldTitle} textView={TextView.C3}>
            Projected Yield after Fees:
          </Text>
          <div className={styles.yieldValuesContainer}>
            <Text className={styles.profit}>+ $100,000</Text>
            <Text className={styles.actualProfit}>≈ $10,000.00</Text>
          </div>
