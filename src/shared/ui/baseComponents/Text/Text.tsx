...
export const Text: ComponentWithProps<TextProps> = ({
  ...
  switch (textView) {
    case TextView.H1:
      return <h1 className={clsx(styles.h1, styles.root, className)}>{children}</h1>;
    case TextView.H2:
      return <h2 className={clsx(styles.h2, styles.root, className)}>{children}</h2>;
    case TextView.H3:
      return <h3 className={clsx(styles.h3, styles.root, className)}>{children}</h3>;
    case TextView.H4:
